...
class AdminFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'admin' => ['type' => 'integer', 'length' => 225, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'Admin_fk0' => ['type' => 'index', 'columns' => ['admin'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'Admin_fk0' => ['type' => 'foreign', 'columns' => ['admin'], 'references' => ['user', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
